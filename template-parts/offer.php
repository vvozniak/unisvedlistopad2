  ...
  ?>
        ...
        ?>
          <section class="bg-secondary py-20 pb-[20vh] relative">
            <div class="md:ml-16 fixed-content flex-col lg:w-1/2 text-light p-8 link_li <?php if (strlen(get_the_title()) > 9): echo 'lg:min-w-[430px] xl:min-w-[450px] 2xl:min-w-[500px] md:mr-30 2xl:mr-0';
                                                                                        endif; ?>">
              <div id="offer-head-dynamic-<?php echo $counter; ?>" class="hidden flex flex-col items-start">
            ...
            <div id="offer-details-<?php echo $counter; ?>" class="hidden mt-10 text-light px-6 md:ml-16 md:mr-64 flex justify-end">
              <div class="mx-5 md:min-w-[450px]">
                ...
                <div class="w-24 h-px bg-primary my-4"></div>
                <h3 class="text-2xl  text-primary libre-baskerville-regular">Cena i szczegóły:</h3>
                <p class="inter-thin"><?php echo get_field('cena_i_szczegoly'); ?></p>
                <div class="w-24 h-px bg-primary my-4"></div>
                <h3 class="text-2xl  text-primary libre-baskerville-regular">Możliwość łączenia pakietów</h3>
                <p class="inter-thin"><?php echo get_field('mozliwosc_laczenia_pakietow'); ?></p>
              </div>
            </div>
          </section>
        <?php
        ...
        ?>
          <section class="bg-secondary py-20 mb-10 relative">
            <div class="    md:mr-16 md:ml-64  px-6 flex flex-col lg:flex-row items-center justify-between">
              ...
              <div id="offer-head-static-<?php echo $counter; ?>" class="text-light p-8 link_li">
            ...
            <div class="fixed-content  text-light p-8 link_li float-right md:mr-16">
              <div id="offer-head-dynamic-<?php echo $counter; ?>" class="hidden flex flex-col">
                <div class="flex items-center mb-4 justify-end">
                  <h2 class="text-[1.4rem] md:text-[2.87vw] libre-baskerville-regular text-right text-balance">UNISVED<br><?php echo get_the_title(); ?></h2>
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/small_c.svg" alt="C shape" class="ml-4 flex-shrink-0 w-10">
                </div>
        ...
        ?>
          <section class="bg-secondary py-20 mb-10 relative">
            <div class="md:mr-16 fixed-content flex-col lg:w-1/3 text-light p-8 link_li float-right">
              <div id="offer-head-dynamic-<?php echo $counter; ?>" class="hidden flex flex-col items-end">
                <div class="flex items-center mb-4 justify-end">
                  <h2 class="text-[1.4rem] md:text-[2.87vw] libre-baskerville-regular text-right text-balance">UNISVED<br><?php echo get_the_title(); ?></h2>
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/small_c.svg" alt="C shape" class="ml-4 flex-shrink-0 w-10">
                </div>
