...
// --- POCZĄTEK ZMIENNYCH - LOGIKA ZCENTRALIZOWANA ---
// Ustawienia domyślne dla języka polskiego (PL)
...
// Ustawienia dla języka szwedzkiego (SV)
...
// Ustawienia dla języka angielskiego (EN)
elseif ( defined('ICL_LANGUAGE_CODE') && ICL_LANGUAGE_CODE == 'en' ) {
    $offer_post_type = 'oferta_en';
    $read_more_text = __( '( READ MORE )', $text_domain );
    $hide_text = __( '( HIDE )', $text_domain );
    
    // Pola dla szablonu 1
    $szablon1_wlwyl_field = 'szablon_1_wlwyl_en';
    $podtytul1_field = 'podtytul1_en';
    $dla_kogo1_field = 'dla_kogo1_en';
    $zakres_uslug_kropki_field = 'zakres_uslug1_en';
    $zakres_uslug_polkola_field = 'zakres_uslug2_en';
    $efekt1_field = 'efekt1_en';
    // Pola dla szablonu 2
    $szablon2_wlwyl_field = 'szablon_2_wlwyl_en';
    $podtytul2_field = 'podtytul2_en';
    $dla_kogo2_field = 'dla_kogo2_en';
    $sklad2_field = 'sklad_en';
    $cena_szczegoly2_field = 'cena_i_szczegoly_en';
    $mozliwosc_laczenia2_field = 'mozliwosc_laczenia_pakietow_en';
}
// --- KONIEC ZMIENNYCH ---
?>
            ...
            <div class="md:ml-16 fixed-content flex-col lg:w-1/2 text-light p-8 link_li <?php if (strlen(get_the_title()) > 9): echo 'lg:min-w-[430px] xl:min-w-[450px] 2xl:min-w-[500px] md:mr-5 xl:mr-30 2xl:mr-0'; endif; ?>">
              <div id="offer-head-dynamic-mobile-<?php echo $counter_mobile; ?>" class="hidden flex flex-col items-start">
                <div class="flex items-center mb-4 <?php if (strlen(get_the_title()) > 9): echo 'lg:min-w-[50vw] 2xl:min-w-[50vw]'; endif; ?>">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/left_c.svg" alt="C shape" class="mr-4 w-10">
                  <h2 class="text-[1.4rem] md:text-[2.87vw] libre-baskerville-regular text-balance">
                    <?php if ( defined('ICL_LANGUAGE_CODE') && ICL_LANGUAGE_CODE == 'en' ): ?>
                        UNISVED<br><?php echo get_the_title(); ?>
                    <?php else: ?>
                        UNISVED <br><?php echo get_the_title(); ?>
            ...
            <div class="md:mr-16 md:ml-32 xl:ml-64 px-6 flex flex-col lg:flex-row items-center justify-between">
              <div id="offer-head-static-mobile-<?php echo $counter_mobile; ?>" class="text-light p-8 link_li order-1 lg:order-2">
                <div class="flex items-center mb-4 justify-end">
                  <h2 class="text-[1.4rem] md:text-[2.87vw] libre-baskerville-regular text-right text-balance">
                    <?php if ( defined('ICL_LANGUAGE_CODE') && ICL_LANGUAGE_CODE == 'en' ): ?>
                        UNISVED<br><?php echo get_the_title(); ?>
                    <?php else: ?>
                        UNISVED<br><?php echo get_the_title(); ?>
          ...
          <section class="offer-section py-20 mb-10 relative">
              ...
              <div class="lg:w-1/3 text-light link_li offer-text-block <?php if (strlen(get_the_title()) > 7): echo 'lg:min-w-[430px] 2xl:min-w-[500px] md:mr-5 xl:mr-30 2xl:mr-0'; endif; ?>">
                <div class="offer-header-wrapper offer-header-sticky">
                  <div id="offer-head-static-desktop-<?php echo $counter_desktop; ?>" class="offer-header-static">
                    ...
                    <p id="offer-p-static-desktop-<?php echo $counter_desktop; ?>" class="md:text-[1vw] mb-1 2xl:mb-4 ml-14 2xl:text-nowrap inter-thin"><?php echo get_field($podtytul1_field) ?></p>
                    <a href="#" id="toggle-offer-desktop-<?php echo $counter_desktop; ?>" class="text-primary tracking-20 md:text-[1vw] ml-14 transition duration-200 hover:font-bold"><?php echo $read_more_text; ?></a>
                  </div>
                  <div id="offer-head-dynamic-desktop-<?php echo $counter_desktop; ?>" class="offer-header-dynamic hidden">
                    ...
                    <p class="md:text-[1vw] mb-1 2xl:mb-4 2xl:text-nowrap ml-14 inter-thin"><?php echo get_field($podtytul1_field) ?></p>
                    <a href="#" id="toggle-offer-dynamic-desktop-<?php echo $counter_desktop; ?>" class="text-primary tracking-20 md:text-[1vw] ml-14 transition duration-200 hover:font-bold"><?php echo $hide_text; ?></a>
                  </div>
                </div>
              </div>
            ...
            <div id="offer-details-desktop-<?php echo $counter_desktop; ?>" class="hidden mt-10 text-light px-6 md:ml-[50vw] md:mr-32 flex justify-end">
              <div class="mx-5 md:min-w-[450px]">
                ...
                <h3 class="text-2xl text-primary mb-10 libre-baskerville-regular"><?php _e('Zakres usług:', $text_domain); ?></h3>
                <?php 
                $polkola_content_desktop = get_field($zakres_uslug_polkola_field);
                ...
                <?php 
                $kropki_content_desktop = get_field($zakres_uslug_kropki_field);
          ...
          <section class="offer-section bg-secondary py-20 pb-[20vh] relative">
              ...
              <div class="lg:w-1/3 text-light link_li offer-text-block <?php if (strlen(get_the_title()) > 9): echo 'lg:min-w-[430px] xl:min-w-[450px] 2xl:min-w-[500px] md:mr-5 xl:mr-30 2xl:mr-0'; endif; ?>">
                <div class="offer-header-wrapper offer-header-sticky">
                  <div id="offer-head-static-desktop-<?php echo $counter_desktop; ?>" class="offer-header-static">
                    ...
                    <p id="offer-p-static-desktop-<?php echo $counter_desktop; ?>" class="md:text-[1vw] mb-1 2xl:mb-4 ml-14 2xl:text-nowrap inter-thin"><?php echo get_field($podtytul2_field) ?></p>
                    <a href="#" id="toggle-offer-desktop-<?php echo $counter_desktop; ?>" class="text-primary tracking-20 md:text-[1vw] ml-14 transition duration-200 hover:font-bold"><?php echo $read_more_text; ?></a>
                  </div>
                  <div id="offer-head-dynamic-desktop-<?php echo $counter_desktop; ?>" class="offer-header-dynamic hidden">
                    <div class="flex items-center">
            ...
            <div id="offer-details-desktop-<?php echo $counter_desktop; ?>" class="hidden mt-10 text-light px-6 md:ml-[50vw] md:mr-32 flex justify-end">
              <div class="mx-5 md:min-w-[450px]">
                ...
                <?php 
                $sklad_content_desktop = get_field($sklad2_field);
          ...
          <section class="offer-section bg-secondary py-20 mb-10 relative">
              ...
              <div class="text-light link_li order-1 lg:order-2 offer-text-block">
                <div class="offer-header-wrapper offer-header-right offer-header-sticky">
                  <div id="offer-head-static-desktop-<?php echo $counter_desktop; ?>" class="offer-header-static">
                    ...
                    <p id="offer-p-static-desktop-<?php echo $counter_desktop; ?>" class="md:text-[1vw] mb-1 2xl:mb-4 mr-14 text-right 2xl:text-nowrap text-wrap inter-thin"><?php echo get_field($podtytul1_field) ?></p>
                    <a href="#" id="toggle-offer-desktop-<?php echo $counter_desktop; ?>" class="text-primary tracking-20 md:text-[1vw] mr-14 text-right block transition duration-200 hover:font-bold"><?php echo $read_more_text; ?></a>
                  </div>
                  <div id="offer-head-dynamic-desktop-<?php echo $counter_desktop; ?>" class="offer-header-dynamic hidden">
                    <div class="flex items-center mb-4 justify-end">
                      <h2 class="text-[1.4rem] md:text-[2.87vw] libre-baskerville-regular text-right text-balance">
                    ...
                    <p class="md:text-[1vw] mb-1 2xl:mb-4 mr-14 text-right 2xl:text-nowrap text-wrap inter-thin"><?php echo get_field($podtytul1_field) ?></p>
                    <a href="#" id="toggle-offer-dynamic-desktop-<?php echo $counter_desktop; ?>" class="text-primary tracking-20 md:text-[1vw] mr-14 text-right block transition duration-200 hover:font-bold"><?php echo $hide_text; ?></a>
                  </div>
                </div>
              </div>
            ...
            <div id="offer-details-desktop-<?php echo $counter_desktop; ?>" class="hidden mt-10 text-light px-6 md:mr-16 md:ml-64 w-1/3">
              <div class="mx-5">
                ...
                <h3 class="text-2xl text-primary mb-10 libre-baskerville-regular"><?php _e('Zakres usług:', $text_domain); ?></h3>
                 <?php 
                $polkola_content_desktop_right = get_field($zakres_uslug_polkola_field);
                ...
                <?php 
                $kropki_content_desktop_right = get_field($zakres_uslug_kropki_field);
                ...
                <div class="w-[100%] h-px bg-primary my-8"></div>
                <h3 class="text-2xl text-primary mb-10 libre-baskerville-regular"><?php _e('Efekt:', $text_domain); ?></h3>
                <p class="mb-4 text-wrap inter-thin"><?php echo get_field($efekt1_field); ?></p>
              </div>
            </div>
          </section>
        <?php
        ...
        ?>
          <section class="offer-section bg-secondary py-20 mb-10 relative">
            ...
            <div id="offer-details-desktop-<?php echo $counter_desktop; ?>" class="hidden mt-4 text-light">
              ...
              <h3 class="text-2xl text-primary mb-10 libre-baskerville-regular"><?php _e('W skład pakietu wchodzi:', $text_domain); ?></h3>
              <?php 
              $sklad_content_desktop_right = get_field($sklad2_field);
    ...
    function initializeDesktopOfferToggles() {
      for (let i = 0; i < <?php echo $counter_desktop; ?>; i++) {
        ...
        function toggleOffer(e) {
          ...
          const readMoreText = '<?php echo $read_more_text; ?>';
          const hideText = '<?php echo $hide_text; ?>';
