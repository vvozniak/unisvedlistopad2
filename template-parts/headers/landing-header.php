<header class="relative h-[180vh] md:h-[170vh] overflow-hidden bg-secondary overflow-x-hidden ">
    ...
    <div class="absolute top-[100vh] left-[5vw] md:left-[17vw] inset-0 flex flex-col items-start justify-start z-20 text-left px-4 md:w-2/3">
        <h1 class="text-light text-[1.8rem] md:text-[4.8rem] libre-baskerville-regular mb-[5vh] md:mb-[15vh]">Budujemy mosty biznesowe <br> między Polską a Skandynawią.</h1>
        <div class="flex flex-col md:flex-row w-[80%] items-start justify-start mt-4">
            ...
            <div class="w-full md:w-1/2 md:h-[20vh] pt-5 md:pt-0">
                <p class="text-light text-[1.9rem] mt-auto inter-regular ml-[20vh] w-[max-content]">Wprowadzamy firmy na nowe rynki i <br>wspieramy ich rozwój w obu kierunkach.<br><br>Skontaktuj się z nami i razem <br> przekroczmy granice biznesu.</p>
            </div>
        </div>
    </div>
