...
<header class="relative min-h-[150vh] md:min-h-[120vh] overflow-hidden text-light">
    ...
    <img src="<?php echo get_template_directory_uri(); ?>/assets/o_nas_svg1.svg" alt="brandowy element dekoracyjny 1" class="absolute inset-0 z-10 top-[15vh] left-0 w-[16vw] md:w-[8vw] h-auto object-cover">
    ...
    <div class="absolute top-[45vh] md:top-[40vh] left-0 md:left-[17vw] inset-0 flex flex-col items-center justify-start z-20 text-left md:px-4 w-screen md:w-2/3">
        <h1 class="ps-10 md:px-auto text-light text-[1.8rem] md:text-[3rem] libre-baskerville-regular mb-[15vh]">Hej! Nazywam się Aleksandra<br>i jestem założycielką Unisved</h1>
        <div class="flex flex-col md:flex-row w-[80%] items-center justify-center mt-4 gap-x-[10vh]">
            <div class="w-full md:w-1/2 md:h-[20vh] flex items-start justify-start pt-2">
