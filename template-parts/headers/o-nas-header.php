...
<header class="relative min-h-[120vh] overflow-hidden text-light">
    ...
    <img src="<?php echo get_template_directory_uri(); ?>/assets/o_nas_svg1.svg" alt="brandowy element dekoracyjny 1" class="absolute inset-0 z-10 top-[15vh] left-0 w-[8vw] h-auto object-cover">

    <img src="<?php echo get_template_directory_uri(); ?>/assets/o_nas_svg2.svg" alt="brandowy element dekoracyjny 2" class="absolute z-10 top-[50vh] right-0 w-[5vw] h-auto object-cover">

    <div class="absolute top-[40vh] left-[17vw] inset-0 flex flex-col items-center justify-start z-20 text-left px-4 w-2/3">
        <h1 class="px-auto text-light text-[3rem] libre-baskerville-regular mb-[15vh]">Hej! Nazywam się Aleksandra<br>i jestem założycielką Unisved</h1>
