...
<header class="relative h-[180vh] md:h-[120vh]  text-light">
    ...
    <div class="absolute top-[45vh] md:top-[25vh] left-0 md:left-[17vw] inset-0 flex flex-col items-start justify-start z-20 text-left md:px-4 w-screen md:w-screen">
        <h1 class="ps-10 md:ps-10 text-light text-[4vw] libre-baskerville-regular mb-[15vh]">Hej! Nazywam się Aleksandra<br>i jestem założycielką Unisved</h1>
        <div class="flex flex-col md:flex-row w-[80%] items-start justify-start mt-4 gap-x-[10vh] ">
            ...
            <div class="w-1/2 md:h-[20vh] pt-5 md:pt-0">
                <p class="text-light text-[1.3vw] mt-auto inter-regular">Firmy, która powstała, aby wspierać przedsiębiorstwa w rozwoju na rynkach skandynawskich i międzynarodowych.</p>
                <p class="text-light text-[1vw] mt-8 inter-regular">Moja historia ze Skandynawią rozpoczęła się w 2006 roku, kiedy zamieszkałam w Szwecji. Dzięki wieloletniemu doświadczeniu w różnych branżach poznałam zarówno skandynawską kulturę i społeczeństwo, jak i unikalny sposób prowadzenia biznesu, który stał się fundamentem mojej obecnej pracy.</p>
                <p class="text-light text-[1vw] mt-4 inter-regular">W 2018 roku postanowiłam wykorzystać tę wiedzę, tworząc Unisved – most łączący międzynarodowe firmy z rynkiem skandynawskim. Moim celem jest wspieranie klientów w czerpaniu korzyści z dynamicznego rozwoju Skandynawii oraz pomaganie im w osiąganiu sukcesów na arenie międzynarodowej.</p>
            </div>
        </div>
    </div>
</header>