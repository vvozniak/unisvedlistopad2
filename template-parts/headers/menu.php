    ...
    <div class="lg:flex lg:items-center py-6 px-10">
        <div class="flex justify-between items-center">
            ...
            <div class="lg:hidden">
                <a href="#" aria-label="Toggle navigation" id="primary-menu-toggle">
                    <svg id="hamburger-icon" viewBox="0 0 20 20" class="inline-block w-6 h-6 text-light" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"> <?php // Ensure icon color is visible 
                                                                                                                                                                                                        ?>
        ...
        <?php wp_nav_menu(
            array(
                ...
                'container_class' => ' fixed inset-0 bg-black bg-opacity-90 z-[998] flex items-center justify-center lg:bg-transparent lg:relative lg:block lg:mt-0 lg:p-0',
