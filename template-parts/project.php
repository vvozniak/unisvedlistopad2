...
<section class="bg-secondary text-light py-24">
  <div class="container mx-auto px-4">
    <div class="fixed-side-container" data-fixed-side="left">
    <div class="fixed-content items-center mb-24">
      <div class="flex items-start">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/left_c.svg" alt="" class="w-24 h-auto mr-8"></img>
        <div>
          <h1 class="text-5xl font-bold leading-tight">Horisontal Holding AB</h1>
          <p class="text-3xl mt-4">Skuteczny rozwój trzech firm w ramach jednego holdingu</p>
        </div>
      </div>
      </div>
      <div class="scrollable-wrapper">
        <div class="scrollable-content">
          <div class="text-lg" style="margin-bottom: 12.5rem;">
            ...
            <div>
              <h2 class="text-4xl font-bold mb-8">Firmy wchodzące w skład holdingu:</h2>
              <ul class="space-y-6">
                <li class="flex items-start">
                  <div class="w-3 h-3 bg-primary rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <p class="font-bold text-2xl">Horisontalplan AB (2018)</p>
                ...
                <li class="flex items-start">
                  <div class="w-3 h-3 bg-primary rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <p class="font-bold text-2xl">Horisontal AB (2020)</p>
                ...
                <li class="flex items-start">
                  <div class="w-3 h-3 bg-primary rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <p class="font-bold text-2xl">SMP Bygg (2021)</p>
            ...
            <div class="flex justify-center items-center">
              <div class=" rounded-[5rem] py-12 px-20 inline-block relative">
                <?php
     ...
     <div class="fixed-side-container" data-fixed-side="right">
      ...
      <div class="fixed-content flex justify-end">
          <div class="flex flex-col items-end justify-center text-right">
            <h4 class="text-right text-[2.5rem] libre-baskerville-regular pe-4"><?php echo get_the_title(); ?></h4>
            <p class="text-right text-[1.8rem] libre-baskerville-regular pe-4"><?php echo get_field('podtytul'); ?></p>
          </div>
...
<div class="fixed-side-container" data-fixed-side="left">
      ...
      <div class="fixed-content flex justify-end">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/assets/left_c.svg" alt="">
      </div>
      <div class="scrollable-wraper">
        <div class="scrollable-content">
          <div class="text-lg" style="margin-bottom: 8rem;">
